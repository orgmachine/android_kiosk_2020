...
import com.ehealthkiosk.kiosk.ui.activities.basicreport.ReportActivity;
...
public class ECGTestFragment extends BaseFragment {
    ...
    @BindView(R.id.layout_setup_ecg)
    ...
    protected int getLayout() {
        return R.layout.fragment_test_ecg;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_continue:
                Intent i1 = new Intent(mActivity, ReportActivity.class);
                startActivity(i1);
                break;
