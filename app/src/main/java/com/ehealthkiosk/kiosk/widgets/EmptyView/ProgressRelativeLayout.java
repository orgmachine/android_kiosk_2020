package com.ehealthkiosk.kiosk.widgets.EmptyView;
...
import com.ehealthkiosk.kiosk.widgets.MaterialProgress.MaterialProgressBar;
...
public class ProgressRelativeLayout extends RelativeLayout {
    ...
    MaterialProgressBar loadingStateProgressBar;
    ...
    private void switchState(String state, int drawable, String errorText, String errorTextContent,
        ...
        switch (state) {
            ...
            case ERROR:
                ...
                errorStateTitleTextView.setText(errorText);
                if (Common_Utils.isNotNullOrEmpty(errorTextContent)) {
    ...
    private void setLoadingView() {
        if (loadingStateRelativeLayout == null) {
            ...
            // Setup ProgressBar
            loadingStateProgressBar = (MaterialProgressBar) view.findViewById(R.id.progress_bar_loading);
            ...
            loadingStateProgressBar.setColorSchemeResources(R.color.colorPrimary, R.color.colorAccent, R.color.colorPrimary, R.color.colorAccent);
